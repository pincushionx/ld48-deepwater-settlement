...
namespace Pincushion.LD48
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        public Vector2 minScroll = new Vector2(-10, -8);
        public Vector2 maxScroll = new Vector2(20, 4);
        ...
        void Update()
        {
            ...
            if (translation.x < 0 && (transform.position.x < minScroll.x))
            {
                return;
            }
            if (translation.x > 0 && (transform.position.x > maxScroll.x))
            {
                return;
            }
            if (translation.y < 0 && (transform.position.y < minScroll.y))
            {
                return;
            }
            if (translation.y > 0 && (transform.position.y > maxScroll.y))
            {
                return;
            }
